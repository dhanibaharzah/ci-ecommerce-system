...
<div class="wrapper">
    ...
    <div class="total shadow">
        ...
        <div class="list">
            <p>Potongan</p>
            <p id="potonganCouponCheckoutPageShow">Rp0</p>
        </div>
        <div class="list">
            <p>Total Tagihan</p>
        ...
        <div class="form-group mt-2">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="MASUKAN KUPON" autocomplete="off" id="inputCouponCheckoutPage">
                <div class="input-group-append">
                    <button class="btn btn-secondary text-light btn-apply-coupon" type="button" id="btnForApplyCouponCheckoutPage">TERAPKAN</button>
                </div>
            </div>
            <small class="text-danger" id="msgDangerCouponWrongCheckoutPage"></small>
            <small class="text-success mt-1" id="msgSuccessCouponCheckout" style="display: none;">Kupon berhasil gunakan</small>
        </div>
        <?php if($cart->num_rows() > 0){ ?>
