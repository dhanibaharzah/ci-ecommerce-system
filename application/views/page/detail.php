<div class="wrapper">
    ...
    <div class="top">
        <div class="main-top">
            ...
            <div class="ket">
                ...
                <?php }else{ ?>
                <a href="<?= base_url(); ?>login" class="btn btn-warning pl-5 pr-5">Beli</a>
                <a href="<?= base_url(); ?>login" class="btn btn-primary">Tambah ke Keranjang</a>
                <?php } ?>
            </div>
        </div>
    </div>
    ...
    <div class="description">
        <div class="top-desc">
            <h4 class="title-desc">Deksripsi</h4>
            <button class="share">
